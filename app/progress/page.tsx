    ...
    <div className={styles.container}>
      ...
      <div className={styles.topCards}>
        <div className={styles.card}>
          ...
          <div className={styles.ringWrap}>
            <svg width="120" height="120" viewBox="0 0 120 120" className={styles.ring}>
              ...
              <defs><linearGradient id="progressGrad" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#F9FAFC"/><stop offset="100%" stopColor="#00D0E6"/></linearGradient></defs>
            </svg>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.streakDots}>
            {[0.3, 0.5, 0.7, 1, 0.5, 0.8, 1].map((opacity, i) => (
              <div key={i} className={styles.streakDot} style={{ opacity, background: i >= 5 ? 'linear-gradient(135deg, #F9FAFC, #00D0E6)' : '#F9FAFC' }} />
            ))}
          </div>
        </div>
        ...
        <div className={styles.card}>
          ...
          <span className={styles.cardHint} style={{ color: '#00D0E6' }}>Best week this month</span>
          ...
          <div className={styles.activityChart}>
            {weekDays.map((day, i) => (
              <div key={i} className={styles.activityCol}>
                <div className={styles.activityBar} style={{ height: `${weekData[i]}px`, background: i === 5 ? 'linear-gradient(180deg, #F9FAFC, rgba(249, 250, 252,0.2))' : `linear-gradient(180deg, rgba(249, 250, 252,${weekData[i]/200 + 0.2}), rgba(249, 250, 252,0.08))` }} />
                <span className={styles.activityDay} style={{ color: i === 5 ? '#F9FAFC' : undefined }}>{day}</span>
              </div>
            ))}
          </div>
        </div>
