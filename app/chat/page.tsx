    ...
    <div className={styles.container}>
          ...
          {messages.map(msg => (
            ...
            >
              <div className={styles.msgAvatar}>
                {msg.role === 'user' ? 'USR' : (
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1L14 4.5V11.5L8 15L2 11.5V4.5L8 1Z" stroke="#00D0E6" strokeWidth="1.2" fill="none"/><circle cx="8" cy="8" r="2" fill="#00D0E6"/></svg>
                )}
              </div>
      ...
      <div className={styles.inputArea}>
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M1 8l6-6v4h7v4H7v4L1 8z" fill="#00D0E6"/></svg>
        </motion.button>
      </div>
    </div>
  );
