  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <div className={styles.sectionIcon}>
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M13 6a3 3 0 00-6 0v2H5v8h8V8h-2V6zm-2 0v2H9V6a1 1 0 012 0z" fill="rgba(124,92,255,0.6)"/></svg>
          </div>
          <div>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <div className={styles.sectionIcon}>
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 1L16 5.5V12.5L9 17L2 12.5V5.5L9 1Z" stroke="rgba(124,92,255,0.6)" strokeWidth="1.3" fill="none"/><circle cx="9" cy="9" r="2" fill="rgba(124,92,255,0.6)"/></svg>
          </div>
          <div>
